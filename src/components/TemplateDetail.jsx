...
// preview beside a panel to start with this design or browse the rest.
export default function TemplateDetail({
  ...
  const settings = applyPresetToSettings(
  ...
  return (
    <div className="tdetail-page">
      <div
        className="tdetail"
        style={{ '--tdetail-accent': color }}
      >
        <div
          className="tdetail-preview-col"
          ref={columnRef}
        >
          <div
            className="tdetail-paper"
            style={{ zoom: scale }}
          >
            <Template
        ...
        <div className="tdetail-info">
          ...
          >
            ...
            <span className="tdetail-crumb-current">
              {template.name}
            </span>
          </nav>

          <h1 className="tdetail-title">
            <span className="tdetail-title-name">
              {template.name}
            </span>{' '}
            resume template
          </h1>
          ...
          <p className="tdetail-lead">
            Build a polished, ATS-friendly resume with our free online
            builder. Start with this design, or browse the rest — you can
            switch or recolor at any time.
          </p>
          ...
          <div className="tdetail-actions">
            <button
              ...
              onClick={() =>
                onUse(template.layout, color, template.preset)
              }
            >
              Use this template
            </button>
