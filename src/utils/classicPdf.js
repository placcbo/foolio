...
// Per-template exporter for ClassicTemplate — draws the serif, centered
// design directly from resume data. Times is a built-in PDF core font, so
// like Simple's exporter there is nothing to rasterize, load, or mismeasure.

export function exportClassicTemplatePdf(resume, filename = 'resume') {
